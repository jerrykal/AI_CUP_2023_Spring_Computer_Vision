...
import torch
from dataset import ShotTypeDataset, load_features, load_labels
...
def main(args):
    ...
    train_dataset = ShotTypeDataset(train_features, train_labels)
    ...
    val_dataset = ShotTypeDataset(val_features, val_labels)
