...
import torch
from dataset import BallHeightDataset, load_features, load_labels
...
def main(args):
    ...
    train_dataset = BallHeightDataset(train_features, train_labels)
    ...
    val_dataset = BallHeightDataset(val_features, val_labels)
